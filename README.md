...
#### 로그인
> 사원번호와 비밀번호를 입력하여 로그인 할수있다. 리턴으로 토큰값을 얻을 수 있다.
...
#### 로그인한 사원의 담당 매장 리스트 조회
> 로그인한 사원의 토큰을 입력하여 조회할 수 있다.


#### 로그인한 사원의 담당 매장의 상세정보 조회
> 로그인한 사원의 토큰과 매장아이디를 입력하여 조회할 수 있다.


#### 로그인한 사원이 담당한 매장이 작성한 재고요청서를 리스트로 조회
> ㅇㄴㅁㄹㄴㅇㅁㄹ 


#### 로그인한 사원이 담당한 매장이 작성한 건의사항을 리스트로 조회
> ㅇㄴㄹㄴㅇㅁㄹㄴㅁㅇㄹ
